...
// GetInitParameters of this VSphereHostVirtualSwitch
func (tr *VSphereHostVirtualSwitch) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereHostVirtualSwitch
func (tr *VSphereHostVirtualSwitch) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
