...
// GetInitParameters of this VSphereDistributedPortGroup
func (tr *VSphereDistributedPortGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereDistributedPortGroup
func (tr *VSphereDistributedPortGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
