...
// GetInitParameters of this VSphereDistributedVirtualSwitch
func (tr *VSphereDistributedVirtualSwitch) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereDistributedVirtualSwitch
func (tr *VSphereDistributedVirtualSwitch) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
