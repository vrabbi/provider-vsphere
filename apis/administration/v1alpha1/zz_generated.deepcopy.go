...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VSphereLicenseInitParameters) DeepCopyInto(out *VSphereLicenseInitParameters) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VSphereLicenseInitParameters.
func (in *VSphereLicenseInitParameters) DeepCopy() *VSphereLicenseInitParameters {
	if in == nil {
		return nil
	}
	out := new(VSphereLicenseInitParameters)
	in.DeepCopyInto(out)
	return out
}
