...
// GetInitParameters of this VSphereLicense
func (tr *VSphereLicense) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereLicense
func (tr *VSphereLicense) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
