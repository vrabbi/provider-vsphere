...
// GetInitParameters of this VSphereComputeCluster
func (tr *VSphereComputeCluster) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereComputeCluster
func (tr *VSphereComputeCluster) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
