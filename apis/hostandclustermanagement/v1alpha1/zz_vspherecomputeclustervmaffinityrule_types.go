...
type VSphereComputeClusterVmAffinityRuleInitParameters struct {
...
type VSphereComputeClusterVmAffinityRuleSpec struct {
	...
	// autoscaler.
	InitProvider VSphereComputeClusterVmAffinityRuleInitParameters `json:"initProvider,omitempty"`
}
...
// VSphereComputeClusterVmAffinityRule is the Schema for the VSphereComputeClusterVmAffinityRules API. Provides the VMware vSphere Distributed Resource Scheduler affinity rule resource.
