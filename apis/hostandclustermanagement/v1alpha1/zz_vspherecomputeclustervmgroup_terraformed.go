...
// GetInitParameters of this VSphereComputeClusterVmGroup
func (tr *VSphereComputeClusterVmGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereComputeClusterVmGroup
func (tr *VSphereComputeClusterVmGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
