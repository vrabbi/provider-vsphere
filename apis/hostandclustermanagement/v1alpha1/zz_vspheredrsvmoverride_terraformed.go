...
// GetInitParameters of this VSphereDrsVmOverride
func (tr *VSphereDrsVmOverride) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereDrsVmOverride
func (tr *VSphereDrsVmOverride) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
