...
// GetInitParameters of this VSphereHost
func (tr *VSphereHost) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereHost
func (tr *VSphereHost) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
