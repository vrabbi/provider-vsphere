...
// GetInitParameters of this VSphereResourcePool
func (tr *VSphereResourcePool) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereResourcePool
func (tr *VSphereResourcePool) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
