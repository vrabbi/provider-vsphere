...
// GetInitParameters of this VSphereComputeClusterHostGroup
func (tr *VSphereComputeClusterHostGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereComputeClusterHostGroup
func (tr *VSphereComputeClusterHostGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
