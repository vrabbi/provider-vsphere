...
// GetInitParameters of this VSphereComputeClusterVmHostRule
func (tr *VSphereComputeClusterVmHostRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereComputeClusterVmHostRule
func (tr *VSphereComputeClusterVmHostRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
