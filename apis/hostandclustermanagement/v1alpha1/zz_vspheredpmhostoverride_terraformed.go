...
// GetInitParameters of this VSphereDpmHostOverride
func (tr *VSphereDpmHostOverride) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereDpmHostOverride
func (tr *VSphereDpmHostOverride) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
