...
// GetInitParameters of this VSphereComputeClusterVmDependencyRule
func (tr *VSphereComputeClusterVmDependencyRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereComputeClusterVmDependencyRule
func (tr *VSphereComputeClusterVmDependencyRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
