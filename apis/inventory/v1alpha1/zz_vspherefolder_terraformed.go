...
// GetInitParameters of this VSphereFolder
func (tr *VSphereFolder) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereFolder
func (tr *VSphereFolder) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
