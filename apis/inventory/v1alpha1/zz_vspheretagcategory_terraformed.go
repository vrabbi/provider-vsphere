...
// GetInitParameters of this VSphereTagCategory
func (tr *VSphereTagCategory) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereTagCategory
func (tr *VSphereTagCategory) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
