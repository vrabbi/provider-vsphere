...
// GetInitParameters of this VSphereTag
func (tr *VSphereTag) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereTag
func (tr *VSphereTag) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
