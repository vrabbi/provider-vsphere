...
// GetInitParameters of this VSphereDatacenter
func (tr *VSphereDatacenter) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereDatacenter
func (tr *VSphereDatacenter) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
