...
type VSphereTagInitParameters struct {
...
type VSphereTagSpec struct {
	...
	// autoscaler.
	InitProvider VSphereTagInitParameters `json:"initProvider,omitempty"`
}
...
// VSphereTag is the Schema for the VSphereTags API. Provides a vSphere tag resource. This can be used to manage tags in vSphere.
