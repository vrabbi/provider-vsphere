...
// GetInitParameters of this VSphereRole
func (tr *VSphereRole) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereRole
func (tr *VSphereRole) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
