...
// GetInitParameters of this VSphereEntityPermissions
func (tr *VSphereEntityPermissions) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereEntityPermissions
func (tr *VSphereEntityPermissions) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
