...
// GetInitParameters of this VSphereContentLibrary
func (tr *VSphereContentLibrary) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereContentLibrary
func (tr *VSphereContentLibrary) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
