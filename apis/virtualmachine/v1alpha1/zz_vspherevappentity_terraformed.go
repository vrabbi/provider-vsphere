...
// GetInitParameters of this VSphereVappEntity
func (tr *VSphereVappEntity) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereVappEntity
func (tr *VSphereVappEntity) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
