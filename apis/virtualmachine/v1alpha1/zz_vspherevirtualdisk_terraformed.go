...
// GetInitParameters of this VSphereVirtualDisk
func (tr *VSphereVirtualDisk) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereVirtualDisk
func (tr *VSphereVirtualDisk) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
