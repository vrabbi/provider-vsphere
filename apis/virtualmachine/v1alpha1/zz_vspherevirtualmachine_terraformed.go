...
// GetInitParameters of this VSphereVirtualMachine
func (tr *VSphereVirtualMachine) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereVirtualMachine
func (tr *VSphereVirtualMachine) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
