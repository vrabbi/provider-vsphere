...
// GetInitParameters of this VSphereStorageDrsVmOverride
func (tr *VSphereStorageDrsVmOverride) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereStorageDrsVmOverride
func (tr *VSphereStorageDrsVmOverride) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
