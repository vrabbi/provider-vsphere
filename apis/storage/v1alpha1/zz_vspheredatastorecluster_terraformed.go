...
// GetInitParameters of this VSphereDatastoreCluster
func (tr *VSphereDatastoreCluster) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereDatastoreCluster
func (tr *VSphereDatastoreCluster) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
