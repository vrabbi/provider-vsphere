...
// GetInitParameters of this VSphereFile
func (tr *VSphereFile) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereFile
func (tr *VSphereFile) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
