...
// GetInitParameters of this VSphereVmfsDatastore
func (tr *VSphereVmfsDatastore) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereVmfsDatastore
func (tr *VSphereVmfsDatastore) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
