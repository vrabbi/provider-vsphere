...
// GetInitParameters of this VSphereNasDatastore
func (tr *VSphereNasDatastore) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VSphereNasDatastore
func (tr *VSphereNasDatastore) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
